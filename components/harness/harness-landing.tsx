...
/**
 * Client wrapper for the /harness showcase chrome (header, hero, stats,
 * closing CTA). Kept client-side so every visible string reacts to the active
 * locale via the shared LocaleProvider; the interactive sections
 * (HarnessExplorer, Primitives) localize themselves.
 */
