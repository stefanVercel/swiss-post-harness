...
export const UI: Record<Locale, Dict> = {
  ...
  fr: {
    ...
    artifactsHint: "Alimenté par les outils field sales (briefings, plans de visite, playbooks).",
    artifactsEmpty:
      "Aucun artefact pour l'instant. Enregistrez un briefing, un plan de visite ou un playbook.",
    articleDrafts: "Playbooks marché",
    reports: "Briefings",
    watchlists: "Plans de visite",
    revPrefix: "rév",
