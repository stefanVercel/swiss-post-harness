...
export const HARNESS: Record<Locale, HarnessCopy> = {
  en: {
    ...
    runTitlePost: ".",
    runLead:
      "Kundenservice, Filiale and Kommunikation aren't three products — they're three compositions of one agent: same model, same sandbox, same semantic layer, differing only in the skills and write tools they switch on. Pick a persona and play the run: on the left the surface a person sees; on the right the shared anatomy each step lights up live.",
    ...
    chartTitle: "Priority volume · by canton",
    chartRows: [
      { label: "Zurich", w: "100%" },
      { label: "Bern", w: "72%" },
      { label: "Vaud", w: "58%" },
    ...
    artifactTitles: { report: "Case briefing", watchlist: "Watchlist", digest: "Digest", draft: "Service-page draft" },
  ...
  fr: {
    ...
    runTitlePost: ".",
    runLead:
      "Kundenservice, Filiale et Kommunikation ne sont pas trois produits — ce sont trois compositions d'un même agent : même modèle, même sandbox, même couche sémantique, ne différant que par les skills et les outils d'écriture qu'ils activent. Choisissez une persona et lancez l'exécution : à gauche la surface que voit une personne ; à droite l'anatomie partagée que chaque étape illumine en direct.",
