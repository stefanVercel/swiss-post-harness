...
export const HARNESS: Record<Locale, HarnessCopy> = {
  ...
  de: {
    ...
    chartTitle: "Routenpriorität · nach Store",
    chartRows: [
      { label: "Coop Zürich HB", w: "100%" },
      { label: "avec Stadelhofen", w: "82%" },
      { label: "Migros Limmatplatz", w: "68%" },
    ...
    artifactTitles: { report: "Routenbriefing", watchlist: "Besuchsplan", digest: "Besuchszusammenfassung", draft: "Market Playbook" },
    statusLabels: { saved: "saved", in_review: "in review", revised: "revised", published: "published" },
    statusSubs: {
      saved: "in der Library gespeichert",
      in_review: "in der Market-Freigabe",
      revised: "zurück in der Review-Queue",
      published: "live im Market Workspace",
    },
  ...
  fr: {
    ...
    chartTitle: "Priorité de tournée · par magasin",
    chartRows: [
      { label: "Coop Zürich HB", w: "100%" },
      { label: "avec Stadelhofen", w: "82%" },
      { label: "Migros Limmatplatz", w: "68%" },
    ...
    artifactTitles: {
      report: "Briefing de tournée",
      watchlist: "Plan de visite",
      digest: "Synthèse de visite",
      draft: "Playbook marché",
    },
    statusLabels: { saved: "enregistré", in_review: "en revue", revised: "révisé", published: "publié" },
    statusSubs: {
      saved: "enregistré dans la bibliothèque",
      in_review: "en validation marché",
      revised: "de retour dans la file de revue",
      published: "en ligne dans le workspace marché",
    },
